...
- For strict OpenAI-compatible remote endpoints that reject non-standard fields (e.g., `top_k`), set `VLLM_STRICT_OPENAI_COMPAT=true` to only send standard OpenAI parameters.
